...
public class Simulation : MonoBehaviour
{
	...
	protected virtual void Start()
	{
		...
		_image.material.mainTexture = displayTexture;
		//settings.width = Mathf.RoundToInt(_image.rectTransform.rect.width);
	}

	public void SetSettings(SlimeSettings settings)
	{
